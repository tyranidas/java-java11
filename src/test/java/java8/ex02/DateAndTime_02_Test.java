...
public class DateAndTime_02_Test {
	...
	public void test_localDate_format_with_hour() {
		...
		String result = localDate.format(DateTimeFormatter.ISO_DATE_TIME);
	...
	public void test_with() {
		...
		LocalDate result = localDate.with(localDate).plusYears(15).plusMonths(1).plusDays(-5);
